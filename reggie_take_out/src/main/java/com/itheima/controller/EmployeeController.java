...
import static com.itheima.common.GlobalConstant.EMPLOYEE_KEY;
...
public class EmployeeController {
    ...
    public R<Employee> login(@RequestBody Employee employeeParam, HttpServletRequest servletRequest) {
        ...
        servletRequest.getSession().setAttribute(EMPLOYEE_KEY, employee.getId());
    ...
    public R<String> save(@RequestBody Employee employeeParam, HttpServletRequest request) {
        ...
        //并设置创建，更新用户ID
        //当前登录用户的ID
        Long employeeId = (Long) request.getSession().getAttribute(EMPLOYEE_KEY);
        //创建人
